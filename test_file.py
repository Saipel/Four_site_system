...
# Функция разделяет каждый жлемент массива на подмассив отдельных элементов
def cep_bas_array(bas: list):
    index = 0
    for elem in bas:
        elem = list(elem)
        bas[index] = elem
...
def auto_complete_ham(basis, array_index):
    """
    # %======================================================================================================
    ...
    for basis_index_line in range(len(basis[array_index])):
        for basis_index_column in range(bias_column + 1, int(len(basis[array_index]))):
            ...
            if (basis[array_index][basis_index_line][0] == basis[array_index][basis_index_column][1] and basis[array_index][basis_index_line][1] == basis[array_index][basis_index_column][0]
            and basis[array_index][basis_index_line][2] == basis[array_index][basis_index_column][2] and basis[array_index][basis_index_line][3] == basis[array_index][basis_index_column][3]
                    and ((basis[array_index][basis_index_line][0] != 0 and basis[array_index][basis_index_line][1] != 0)
                    or (basis[array_index][basis_index_line][0] != 2 and basis[array_index][basis_index_line][1] != 2))):
                print("1 and 2")
                print("line", basis[array_index][basis_index_line])
                print("column", basis[array_index][basis_index_column], "\n")


            # Сравниваем первый и четвертый узел
            if ((basis[array_index][basis_index_line][0] == basis[array_index][basis_index_column][3] and basis[array_index][basis_index_line][3] == basis[array_index][basis_index_column][0]
                    and basis[array_index][basis_index_line][2] == basis[array_index][basis_index_column][2] and basis[array_index][basis_index_line][1] == basis[array_index][basis_index_column][1])\
                    and ((basis[array_index][basis_index_line][0] != 0 and basis[array_index][basis_index_line][3] != 0)
                    or (basis[array_index][basis_index_line][0] != 2 and basis[array_index][basis_index_line][3] != 2))):
                print("1 and 4")
                print("line", basis[array_index][basis_index_line])
                print("column", basis[array_index][basis_index_column], "\n")
            ...
            if (basis[array_index][basis_index_line][1] == basis[array_index][basis_index_column][2] and basis[array_index][basis_index_line][2] == basis[array_index][basis_index_column][1]
                    and basis[array_index][basis_index_line][0] == basis[array_index][basis_index_column][0] and basis[array_index][basis_index_line][3] == basis[array_index][basis_index_column][3]
                    and ((basis[array_index][basis_index_line][1] != 0 and basis[array_index][basis_index_line][2] != 0)
                    or (basis[array_index][basis_index_line][1] != 2 and basis[array_index][basis_index_line][2] != 2))):
                print("2 and 3")
                print("line", basis[array_index][basis_index_line])
                print("column", basis[array_index][basis_index_column], "\n")

            # Сравниваем третий и четвертый узел
            if (basis[array_index][basis_index_line][2] == basis[array_index][basis_index_column][3] and basis[array_index][basis_index_line][3] == basis[array_index][basis_index_column][2]
                    and basis[array_index][basis_index_line][0] == basis[array_index][basis_index_column][0] and basis[array_index][basis_index_line][1] == basis[array_index][basis_index_column][1]
                    and ((basis[array_index][basis_index_line][2] != 0 and basis[array_index][basis_index_line][2] != 0)
                    or (basis[array_index][basis_index_line][3] != 2 and basis[array_index][basis_index_line][3] != 2))):
                print("3 and 4")
                print("line", basis[array_index][basis_index_line])
                print("column", basis[array_index][basis_index_column], "\n")
...
full_bas_array.append(one_part_array)
full_bas_array.append(two_part_array)
full_bas_array.append(three_part_array)
full_bas_array.append(four_part_array)
full_bas_array.append(five_part_array)
full_bas_array.append(six_part_array)
full_bas_array.append(seven_part_array)

auto_complete_ham(full_bas_array, 6)
